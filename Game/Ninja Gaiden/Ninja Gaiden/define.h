...
//Camera
#define CAMERA_WIDTH SCREEN_WIDTH
...
#define GROUND_MINITYPE_GREEN_SPECIAL 2
...
#define CONTAINER_MINITYPE_BUTTERFLY 15
#define CONTAINER_MINITYPE_BIRD 16
#define ITEM_MINITYPE_BAGBLUE 1
#define ITEM_MINITYPE_BAGRED 2
#define ITEM_MINITYPE_SOULBLUE 3
#define ITEM_MINITYPE_SOULRED 4
#define ITEM_MINITYPE_SMALLSHURIKEN 5
#define ITEM_MINITYPE_BIGSHURIKEN 6
#define ITEM_MINITYPE_FIREITEM 7
#define ITEM_MINITYPE_HEALTHPOT 8
#define ITEM_MINITYPE_HOURGLASS 9

#define WEAPON_MINITYPE_SWORD 0
#define WEAPON_MINITYPE_SMALL_SHURIKEN 1
#define WEAPON_MINITYPE_BIG_SHURIKEN 2
#define WEAPON_MINITYPE_FIRE 3 //
#define WEAPON_MINITYPE_FIRES 4
